...
import OperationsTimeline from "../components/Home/OperationsTimeline";
import LinearProgressWithLabel from "../components/Home/LinearProgressWithLabel";
...
export default function Home() {
  ...
  console.log(transactions_emitted);
  return (
